...
from enseg.models.builder import GANLOSSES
...
class DiscShiftLoss(nn.Module):
    ...
    **Note for the design of ``data_info``:**
    In ``ensegeration``, almost all of loss GANLOSSES contain the argument
    ...
    important data/GANLOSSES into a dictionary:
    ...
    def forward(self, *args, **kwargs):
        ...
        the data and necessary GANLOSSES should be passed into this function.
