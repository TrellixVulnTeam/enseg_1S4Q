...
network = dict(
    type="SegMAEfp16",
    pretrained="/home/wzx/weizhixiang/ensegment/pretrain/vit/mmlab/mae_pretrain_vit_large.pth",
...
network = dict(
    type='SegMAEfp16',
    pretrained=
    '/home/wzx/weizhixiang/ensegment/pretrain/vit/mmlab/mae_pretrain_vit_large.pth',
    backbone=dict(
