...
train_pipeline = [
    ...
    dict(type="Resize", img_scale=(1024, 512), ratio_range=(0.8, 1.2)),
...
train_pipeline = [
    ...
    dict(type='LoadAnnotations'),
    dict(type='Resize', img_scale=(1024, 512), ratio_range=(0.8, 1.2)),
    dict(type='RandomCrop', crop_size=(500, 500), cat_max_ratio=0.75),
    dict(type='RandomFlip', prob=0.5),
    dict(
        type='Normalize',
        ...
        to_rgb=True),
    dict(type='Pad', size=(500, 500), pad_val=0, seg_pad_val=255),
    dict(type='DefaultFormatBundle'),
    dict(type='Collect', keys=['img', 'gt_semantic_seg'])
]
test_pipeline = [
