...
network = dict(
    ...
    rec_loss=dict(_delete_=True,type="PixelLoss", loss_weight=1.0, loss_type="L2",),
    seg=dict(
        in_channels=[128, 256, 512, 1024],
        num_classes=19,
        loss_decode=dict(loss_weight=1.0),
    ),
...
optimizer = dict(
    ...
    genA=adamw,
    genB=adamw,
    disA=dict(type="Adam", lr=0.0006, betas=(0.5, 0.999)),
    disB=dict(type="Adam", lr=0.0006, betas=(0.5, 0.999)),
)
lr_config = dict(
    _delete_=True,
    policy="poly",
