...
optimizer = dict(
    _delete_=True,
    backbone=dict(type="SGD", lr=0.00006, momentum=0.9, weight_decay=0.0005),
    backbone_B=dict(type="SGD", lr=0.00006, momentum=0.9, weight_decay=0.0005),
    seg=dict(type="SGD", lr=0.00006, momentum=0.9, weight_decay=0.0005),
)
